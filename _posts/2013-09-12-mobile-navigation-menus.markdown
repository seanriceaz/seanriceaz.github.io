...
<ul class="gallery">
  ...
  <li>{% include galleryitem.html thumb="/media/2013/09/wordpressApp-300x266.png" full="/media/2013/09/wordpressApp.png" caption="The Wordpress App has a menu on the left." %}</li>
